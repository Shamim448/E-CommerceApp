  ...
  let editable = document.querySelectorAll('.editable');
    ...
    function getProfessionalSummary() {
        ...
        const summary = {
            ...
            ProfessionalSummary: professionaltext.innerText
        }
        ...
        $.ajax({
            ...
            success: function (response) {
              ...
              ////  if (response.status ) {
                    ...
                    $("#image-upload").attr("src", location.origin +"/images/"+response);
